...
func (m *Mux) register(mx *http.ServeMux) {
	...
	mx.HandleFunc("GET /branches", m.handleListBranches)
	mx.HandleFunc("POST /worktrees", m.handleCreateWorktree)
	mx.HandleFunc("DELETE /worktrees", m.handleRemoveWorktree)
	mx.HandleFunc("POST /worktrees/merge", m.handleMergeWorktree)
